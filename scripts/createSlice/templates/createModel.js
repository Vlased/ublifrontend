...
module.exports = async (layer, sliceName) => {
    ...
    const createModelStructure = async () => {
        try {
            ...
            console.log(`Model segment for ${sliceName} slice was not found`, e);
        }
    };
    ...
    const createReduxSlice = async () => {
        try {
            ...
            console.log('Could not create redux slice', e);
        }
    };
    ...
    const createSchemaType = async () => {
        try {
            ...
            console.log('Could not create schema state type', e);
        }
    };
