"use strict";
(self["webpackChunkulbi"] = self["webpackChunkulbi"] || []).push([["vendors-node_modules_reduxjs_toolkit_dist_redux-toolkit_esm_js-node_modules_react-redux_es_index_js"],{
...
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @babel/runtime/helpers/esm/extends */ "./node_modules/@babel/runtime/helpers/esm/extends.js");
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @babel/runtime/helpers/esm/objectWithoutPropertiesLoose */ "./node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js");
...
/* harmony import */ var _connect_selectorFactory__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../connect/selectorFactory */ "./node_modules/react-redux/es/connect/selectorFactory.js");
/* harmony import */ var _connect_mapDispatchToProps__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../connect/mapDispatchToProps */ "./node_modules/react-redux/es/connect/mapDispatchToProps.js");
...
/* harmony import */ var _connect_mergeProps__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../connect/mergeProps */ "./node_modules/react-redux/es/connect/mergeProps.js");
...
/* harmony import */ var _utils_warning__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/warning */ "./node_modules/react-redux/es/utils/warning.js");
...
function connect(mapStateToProps, mapDispatchToProps, mergeProps, {
  ...
  if (true) {
    if (pure !== undefined && !hasWarnedAboutDeprecatedPureOption) {
      ...
      (0,_utils_warning__WEBPACK_IMPORTED_MODULE_8__["default"])('The `pure` option has been removed. `connect` is now always a "pure/memoized" component');
    }
  }

  const Context = context;
  const initMapStateToProps = (0,_connect_mapStateToProps__WEBPACK_IMPORTED_MODULE_9__.mapStateToPropsFactory)(mapStateToProps);
  const initMapDispatchToProps = (0,_connect_mapDispatchToProps__WEBPACK_IMPORTED_MODULE_10__.mapDispatchToPropsFactory)(mapDispatchToProps);
  const initMergeProps = (0,_connect_mergeProps__WEBPACK_IMPORTED_MODULE_11__.mergePropsFactory)(mergeProps);
  ...
  const wrapWithConnect = WrappedComponent => {
    ...
    function ConnectFunction(props) {
      const [propsContext, reactReduxForwardedRef, wrapperProps] = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => {
        ...
        const {
          reactReduxForwardedRef
              ...
              wrapperProps = (0,_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_12__["default"])(props, _excluded);

        return [props.context, reactReduxForwardedRef, wrapperProps];
      }, [props]);
      const ContextToUse = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => {
      ...
      const contextValue = react__WEBPACK_IMPORTED_MODULE_1__.useContext(ContextToUse); // The store _must_ exist as either a prop or in context.
      ...
      const childPropsSelector = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => {
        // The child props selector needs the store reference as an input.
        // Re-create this selector whenever the store changes.
        return (0,_connect_selectorFactory__WEBPACK_IMPORTED_MODULE_13__["default"])(store.dispatch, selectorFactoryOptions);
      }, [store]);
      const [subscription, notifyNestedSubs] = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => {
      ...
      const overriddenContextValue = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => {
        ...
        return (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_14__["default"])({}, contextValue, {
          subscription
        });
      }, [didStoreComeFromProps, contextValue, subscription]); // Set up refs to coordinate values between the subscription effect and the render logic

      const lastChildProps = react__WEBPACK_IMPORTED_MODULE_1__.useRef();
      const lastWrapperProps = react__WEBPACK_IMPORTED_MODULE_1__.useRef(wrapperProps);
      const childPropsFromStoreUpdate = react__WEBPACK_IMPORTED_MODULE_1__.useRef();
      const renderIsScheduled = react__WEBPACK_IMPORTED_MODULE_1__.useRef(false);
      const isProcessingDispatch = react__WEBPACK_IMPORTED_MODULE_1__.useRef(false);
      const isMounted = react__WEBPACK_IMPORTED_MODULE_1__.useRef(false);
      const latestSubscriptionCallbackError = react__WEBPACK_IMPORTED_MODULE_1__.useRef();
      ...
      const actualChildPropsSelector = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => {
        const selector = () => {
          // Tricky logic here:
      ...
      const subscribeForReact = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => {
      ...
      const renderedWrappedComponent = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => {
        return (
          /*#__PURE__*/
          // @ts-ignore
          react__WEBPACK_IMPORTED_MODULE_1__.createElement(WrappedComponent, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_14__["default"])({}, actualChildProps, {
      ...
      const renderedChild = react__WEBPACK_IMPORTED_MODULE_1__.useMemo(() => {
    ...
    if (forwardRef) {
      const _forwarded = react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(function forwardConnectRef(props, ref) {
        // @ts-ignore
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(Connect, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_14__["default"])({}, props, {
...
//# sourceMappingURL=vendors-node_modules_reduxjs_toolkit_dist_redux-toolkit_esm_js-node_modules_react-redux_es_index_js.iframe.bundle.js.map